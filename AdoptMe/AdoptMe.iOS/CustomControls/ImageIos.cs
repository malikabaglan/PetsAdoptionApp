...
using AdoptMe.iOS.CustomControls;
using CoreAnimation;
using CoreGraphics;
using UIKit;
using Xamarin.Forms;
using Xamarin.Forms.Platform.iOS;
[assembly:ExportRenderer(typeof(ImageEntry),typeof(ImageIos))]
namespace AdoptMe.iOS.CustomControls
{
    public class ImageIos : EntryRenderer
    {
